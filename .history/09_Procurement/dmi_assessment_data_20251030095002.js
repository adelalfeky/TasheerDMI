...
const DMI_QUESTIONS = [
    ...
    {
        id: "Q10", area: "3. Data & Analytics", title: "Data Quality & Governance",
        text: "How is the quality of master data (supplier, material, contract) ensured and governed?",
        choices: [
            { value: 1, text: "1. No formal data quality checks; data is inconsistent." },
            { value: 2, text: "2. Periodic, manual data cleaning efforts." },
            { value: 3, text: "3. Basic data validation rules in ERP; data governance roles are assigned." },
            { value: 4, text: "4. Automated data validation and cleansing integrated into system workflows with formal data governance policies." },
            { value: 5, text: "5. Continuous data monitoring with automated exception routing and predictive quality alerts." }
        ]
    },
    {
