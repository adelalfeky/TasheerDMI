...
// The link is hidden here, using the requested C:/folder1 path.
    const EVIDENCE_SHARED_FOLDER_PATH = "https://tasheer-my.sharepoint.com/:f:/p/afeky/EhEt-kVFKJxEhVFgQ0ncPE4B7cvLu5oMr3IUY0G2STr-bQ?e=s1Pzk8"; 
   window.open(EVIDENCE_SHARED_FOLDER_PATH, 'https://tasheer-my.sharepoint.com/:f:/p/afeky/EhEt-kVFKJxEhVFgQ0ncPE4B7cvLu5oMr3IUY0G2STr-bQ?e=s1Pzk8');
<a href="https://tasheer-my.sharepoint.com/:f:/p/afeky/EhEt-kVFKJxEhVFgQ0ncPE4B7cvLu5oMr3IUY0G2STr-bQ?e=s1Pzk8" target="_blank" class="btn">
  </a>

   // scripts/login_auth.js

document.getElementById('openFolderBtn').addEventListener('click', function() {
  // Hidden shared folder link (secured here instead of HTML)
  const SHARED_FOLDER_URL = "https://drive.google.com/drive/folders/YOUR_FOLDER_ID_HERE";
  
  // Open in a new tab
  window.open(SHARED_FOLDER_URL, '_blank');
});
